...
--
-- A blue/green reload (ETYM-190) renames `public` to a rollback
-- schema and promotes a freshly-built `loading` schema in its place
-- every run. An extension anchored in `public` would ping-pong
